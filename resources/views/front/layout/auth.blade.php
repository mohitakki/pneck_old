...
<head>
    ...
    <!-- Bootstrap -->
    <link href="{{ url('/front_theme/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Google Fonts -->
   <link href="https://fonts.googleapis.com/css?family=Rubik:300,300i,400,400i,500,500i,700,700i,900,900i" rel="stylesheet">
    <!-- FontAwesome icon -->
    <link href="{{ url('/front_theme/fontawesome/css/fontawesome-all.css')}}" rel="stylesheet">
    <!-- Fontello icon -->
    <link href="{{ url('/front_theme/fontello/css/fontello.css')}}" rel="stylesheet">
     <link rel="stylesheet" type="text/css" href="{{ url('/front_theme/wedding-icon-font/flaticon.css')}}">

    <!-- OwlCarosuel CSS -->
    <link href="{{ url('/front_theme/css/owl.carousel.css')}}" type="text/css" rel="stylesheet">
    <link href="{{ url('/front_theme/css/owl.theme.default.css')}}" type="text/css" rel="stylesheet">
    <!-- Favicon icon -->

    <!-- Style CSS -->
   <link href="{{ url('/front_theme/css/style.css')}}" rel="stylesheet">
    <link href="{{ url('/front_theme/css/style1.css')}}" rel="stylesheet">

    <link rel="stylesheet" type="text/css" href="{{ url('/front_theme/css/dzsparallaxer.css')}}">
      <link rel="stylesheet" type="text/css" href="{{ url('/front_theme/css/jquery.rateyo.css')}}">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-sm-6 col-md-6 col-sm-12 col-12">
                        <div class="header-text text-right">
                           <!-- <p>Are You <a href="{{ route('register') }}" class="text-white">Register</a></p> -->
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <nav class="navbar navbar-expand-lg navbar-transparent">
                        <a class="navbar-brand" href="{{ url('/') }}"> <img src="{{ url('/front_theme/images/logo-white.png') }}" alt=""></a>
   ...
   <div class="social-media-block">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    ...
                    <div class="footer-widget">
                        <a href="#"><img src="{{ url('/front_theme/images/logo-white.png') }}" alt="" class="mb20"></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right">
                    <p>© {{ date('Y') }} Pneck. All Rights Reserved By Pneck. Designed By
    ...
    <script src="{{url('/front_theme/js/jquery.min.js')}}"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
    <script src="{{url('/front_theme/js/bootstrap.min.js')}}"></script>

    <!-- owl-carousel js -->
    <script src="{{url('/front_theme/js/owl.carousel.min.js')}}"></script>
    <!-- nice-select js -->
    <script src="{{url('/front_theme/js/jquery.nice-select.min.js')}}"></script>
    <script src="{{url('/front_theme/js/fastclick.js')}}"></script>
    <script src="{{url('/front_theme/js/custom-script.js')}}"></script>
    <script src="{{url('/front_theme/js/dzsparallaxer.js')}}"></script>
    <script src="{{url('/front_theme/js/return-to-top.js')}}"></script>
    <script src="{{url('/front_theme/js/jquery.rateyo.min.js')}}"></script>
