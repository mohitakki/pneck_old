...
@section('content')
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Vendor Category API Data Show</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/admin/dashboard') }}">Home</a>
                </li>
                <li class="breadcrumb-item"><a href="#">Vendor Category API Data</a>
                </li>
                <li class="breadcrumb-item active"><a href="#">Vendor Category Data</a>
                </li>
              </ol>
            </div>
          </div>
                 ...
                 <!--  <h4 class="card-title" id="from-actions-top-left">Category Details</h4> -->
                  ...
                  <div class="heading-elements">
                    ...
                    <!--   <li><a data-action="collapse"><i class="ft-minus"></i></a></li> -->
                     ...
                     <li><a href="{{ url('/admin/service-create') }}">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    @csrf         
                      ...
                      <div class="form-body">
                        <h4 class="form-section"><i class="ft-user"></i>Category Data Info</h4>
                        <div class="row">
