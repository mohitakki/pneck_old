            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-content collpase show">
                 ...
                 @if (!empty($data))
                 <form action="{{route('admin.rental-update')}}" method="post" enctype="multipart/form-data">
                  {{csrf_field()}}      
                  ...
                  <input type="hidden" value="{{ $data->id }}" name="id" >
                    ...
                    <div class="form-body">
                      ...
                      <div class="row">
                        ...
                        <input type="text"  name="number_hours" class="form-control" placeholder="Hourly Package"  required autocomplete="off" value="{{ $data->number_hours }}"/>
                        </div>


                        <div class="form-group col-md-6 mb-2">                           
                            <label for="projectinput3">Price</label>                         
                            <input type="text" name="price" class="form-control" value="{{ $data->price }}" placeholder="Price" required autocomplete="off" />
                        </div>


                        <div class="form-group col-md-6 mb-2">                           
                            <label for="projectinput3">Disance</label>                         
                            <input type="text" name="distance" class="form-control" value="{{ $data->distance }}" placeholder="Disance"  required autocomplete="off" />
                        </div>
                        ...
                        <div class="form-group col-md-6 mb-2">
                          ...
                          <option>{{ $data->vehicle_type }}</option>
                 ...
                 @else
                    ...
                    <form action="{{route('admin.rental-submit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}         
