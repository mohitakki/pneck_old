...
@section('content')
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Call Create</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a>
                </li>
                <li class="breadcrumb-item active"><a href="#">Add Call Data</a>
                </li>
              </ol>
            </div>
          </div>
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    {{csrf_field()}}         
                      ...
                      <div class="form-body">
                        <h4 class="form-section"><i class="ft-user"></i>Call Info</h4>
                        <div class="row">
                        

                          <div class="form-group col-md-6 mb-2">
                            <label for="projectinput2">Manager Name</label>

                             <input type="text" id="Business Name" name="Business Name" class="form-control" placeholder="Business Name"  required autocomplete="off" value=""/>
                          </div>
                          ...
                          <div class="form-group col-md-6 mb-2">                           
                              ...
                              <textarea id="Confirm Password" name="Confirm Password" class="form-control" placeholder="Confirm Password" required autocomplete="off" ></textarea>
                          </div>
