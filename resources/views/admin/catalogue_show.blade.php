...
@section('content')
              ...
              <div class="card">
                 ...
                 <!--  <h4 class="card-title" id="from-actions-top-left">Category Details</h4> -->
                  ...
                  <div class="heading-elements">
                    ...
                    <!--   <li><a data-action="collapse"><i class="ft-minus"></i></a></li> -->
                     ...
                     <li><a href="{{ url('/admin/catalogue-create') }}">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form action="{{route('admin.catalogue-delete')}}" method="post">
                    @csrf         
                     
                      <div class="form-body">
                        <h4 class="form-section"><i class="ft-user"></i>Category & Catalogue Data Info</h4>
                        <div class="row">
                        ...
                        <div class="form-group col-md-6 mb-2">                           
                          ...
                          <select class="form-control" name="subcat_id" required="true" id="category">
                          </select>
                          </div>
                         ...
                         <!-- <div class="form-group col-md-6 mb-2">                           
                          ...
                          <div class="form-group col-md-6 mb-2">
                              <label for="projectinput3">Select Catalogue</label>

                              <select class="form-control" name="catalogue_id" required="true" id="catalogue">
                          </select>
    ...
    $('#category').change(function(){
        ...
        $.ajax({
           ...
           url:"{{ url('/admin/catalogue')}}/"+sid, //Please see the note at the end of the post**
           success:function(res)
           {       
                if(res)
                {
                    $("#catalogue").empty();
                    $("#catalogue").append('<option>Select Catalogue</option>');
                    $.each(res,function(key,value){
                        $("#catalogue").append('<option value="'+key+'">'+value+'</option>');
                    });
                }
           }
