...
@section('content')
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Employee Edit</h3>
              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form action="{{route('admin.pneckemployee-update')}}" method="post">
                    {{csrf_field()}}         
                     
                      <div class="form-body">
                        <h4 class="form-section"><i class="ft-user"></i>Pneck Employee Info</h4>
                        <div class="row">
                          ...
                          @endphp
                           <div class="form-group col-md-6 mb-2">
                              ...
                              <label for="projectinput2">Employee Pic</label>
