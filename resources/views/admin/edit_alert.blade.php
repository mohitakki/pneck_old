...
@section('content')
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Alert Edit</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Edit Alert</a>
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form action="{{route('admin.alert-update')}}" method="post">
                    {{csrf_field()}}         
                        ...
                        <div class="row">
                            ...
                            <input type="hidden" name="id" value="{{$data->id}}">
                              <label for="projectinput2">Alert for</label>
                                  ...
                                  @if($data->alert_for != '0')
                                    ...
                                    <option value="{{$key}}" @if($data->alert_for == $key) selected @endif>{{$value}}</option>
                                    @endforeach
                                  @else
                          ...
                          <div class="form-group col-md-6 mb-2">
                              ...
                              <select class="form-control" id="alert_type" required="" name="alert_type">
                                    ...
                                    <option value="{{$type->id}}" @if($type->id == $data->alert_type) selected @endif>{{$type->name}}</option>
                                    @endforeach
                              </select>
                          </div>
                           ...
                           <div class="form-group col-md-6 mb-2">                           
                              ...
                              <input type="text" id="alert_title" name="alert_title" class="form-control"  required autocomplete="off" value="{{$data->alert_title}}" />
                          </div>

                          <div class="form-group col-md-6 mb-2">                           
                              <label for="projectinput3">Alert Message</label>                         
                              <input type="text" id="alert_message" name="alert_message" class="form-control"  required autocomplete="off" value="{{$data->alert_message}}" />
                          </div>
