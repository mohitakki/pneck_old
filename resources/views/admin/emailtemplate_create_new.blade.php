               ...
               <div class="card-content collpase show">
                  <div class="card-body">
                     ...
                     <div class="form-group m-form__group ">
                             ...
                             <input type="text" id="email_subject" name="email_heading" class="form-control m-input" required autocomplete="off" value=""/>
                     </div>
                     <div class="form-group m-form__group">
                             <label for="exampleInputEmail1"> Email Subject</label>
                             
                             <input type="text" id="Email Subject" name="email_subject" class="form-control m-input"  >
                     </div>
                     <div class="form-group m-form__group">
                            <label for="exampleInputEmail1"> Email Body</label>

                            <textarea id="email_description" name="email_body" class="form-control m-input"   rows="3" required autocomplete="off" ></textarea>
                     </div>
