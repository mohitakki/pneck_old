...
@section('content')
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">General Setting Create</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a>
                </li>
                <li class="breadcrumb-item active"><a href="#">Add General Setting Data</a>
                </li>
              </ol>
            </div>
          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 mb-2">
                            <label for="projectinput2">Header</label>
                             ...
                             <input type="text" id="header" name="header" class="form-control"  required autocomplete="off" value=""/>
                          </div>

                          <div class="form-group col-md-6 mb-2">
                              <label for="projectinput2">Footer</label>                            
          
                              <input type="text" id="footer" name="footer" class="form-control"  required autocomplete="off" value=""/>
                          ...
                          <div class="form-group col-md-6 mb-2">
                            <label for="projectinput3">Site Title</label>
                               ...
                               <input type="text" id="sitetitle" name="site_title" class="form-control"  required autocomplete="off" value=""/>
                          ...
                          <div class="form-group col-md-6 mb-2">
                              ...
                              <input type="file" id="logo" name="logo" class="form-control"  required autocomplete="off" value=""/>
              
                          </div>

                          <div class="form-group col-md-6 mb-2">                           
                              <label for="projectinput3">Copyright</label>                         
                              <input type="text" id="copyright" name="copyright" class="form-control"  required autocomplete="off" />
                          </div>
