              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form action="{{route('admin.corporates-update')}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}         
                        ...
                        <div class="form-body">
                          ...
                          <div class="row">
                            ...
                            <input type="text" name="business_name" value="{{ $data->business_name }}" class="form-control" placeholder="Business Name"  autocomplete="off" value=""/>
                            </div>
  
  
                            <div class="form-group col-md-6 mb-2">                           
                                <label for="projectinput3">Email</label>                         
                                <input type="text" name="email" value="{{ $data->email }}" class="form-control" placeholder="Email"  autocomplete="off" />
                            </div>
  
  
                            <div class="form-group col-md-6 mb-2">                           
                                <label for="projectinput3">Mobile</label>                         
                                <input type="text" name="mobile_no" value="{{ $data->mobile_no }}" class="form-control" placeholder="Mobile Number"  autocomplete="off" />
                            </div>
  
                            <div class="form-group col-md-6 mb-2">                           
                                <label for="projectinput3">Description</label>                         
                                <textarea name="description" class="form-control" placeholder="Description" autocomplete="off" >{{ $data->description }}</textarea>
                            </div>
                            ...
                            <label for="projectinput3">Address</label>                         
                                <input type="text" name="address" value="{{ $data->address }}" class="form-control" placeholder="Address"  autocomplete="off" />
                            </div>
                            ...
                            <div class="form-group col-md-6 mb-2">                           
                                ...
                                <input type="text" name="confirmpassword" value="{{ $data->confirmpassword }}" class="form-control" placeholder="Confirm Password" autocomplete="off" />
                            </div>
  
                            <div class="form-group col-md-6 mb-2">                           
                                <label for="projectinput3">Paypal Email</label>                         
                                <input type="text" name="paypalemail" value="{{ $data->paypalemail }}" class="form-control" placeholder="Paypal Email"  autocomplete="off" />
                            </div>
                            ...
                            <div class="form-group col-md-6 mb-2">                           
                                ...
                                <img src="{{url('/admin_logos/'.$data->pictureimage) }}" width="100px" height="100px" >
                            </div>
                    ...
                    <form action="{{route('admin.corporates-submit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}         
