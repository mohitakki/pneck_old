                ...
                <div class="card-header">
                  ...
                  <div class="heading-elements">
                    <ul class="list-inline mb-0">
                      ...
                      <li><a href="{{route('admin.add-vehicle-type')}}"><button type="button" class="btn btn-info mr-1 add-button">ADD Vehicle Type</button></a></li>
                    </ul>
                  </div>
                </div>
                      ...
                      @if(!empty($vehicleType))
						...
						@foreach($vehicleType as $key=>$value)
						  ...
						  <tr style="text-align:center">
							...
							<td>{{$value['vehicle_image']}}</td>
							<td>
							  <a href="{{route('admin.editVehicleType', ['id' => $valueId])}}"><i class="la la-pencil"></i></a>
							  <a href="{{route('admin.deleteVehicleType', ['id' => $valueId])}}" data-url="{{route('admin.deleteVehicleType', ['id' => $valueId])}}" class="delete"> <i class="la la-trash"></i></a>
							</td>
						  </tr>
						  <?php $i++; ?>
						@endforeach
