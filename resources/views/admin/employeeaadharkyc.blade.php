            ...
            <div class="card card-shadow" style="align-items: center;display: flex;justify-content: center;">
                <div class="media-left pl-2 pt-2">
                        <a href="#" class="profile-image">
                            ...
                            @else
                            <img src="{{ url('/admin_theme/app-assets/images/avatar-s-19.png') }}" alt="logo" class="rounded-circle img-border height-100"  id="blah" style="background-color: linen;">
                            @endif
                        </a>
                </div>
                <div class="media-left pl-2 pt-2">
                ...
                <div class="media-left" style="padding-top: 0.2rem !important;padding-left: 1.5rem !important;margin-bottom: 1.0rem !important;">
                    ...
                    <input type="file" class="image" id="updatepic" style="display: none" name="aadhar_file">
