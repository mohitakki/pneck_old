          ...
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="#">Add Sub Category Data</a>
                </li>
              </ol>
            </div>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
                    ...
                    <form action="{{route('admin.subcategory-submit')}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}         
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 mb-2">
                            <label for="projectinput2">Sub Category Name</label>
                             ...
                             <input type="text" id="subtitle" name="subtitle" class="form-control" placeholder="Category Name"  required autocomplete="off" value=""/>
                          </div>
