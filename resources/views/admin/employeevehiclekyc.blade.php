...
@section('content')
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Vehicle KYC Upload</h3>
          ...
          <div class="row match-height">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="col-md-12 vehicle_screen" style="display:none;">
                <h2> Please Drag the mouse pointer on image screen for crop this Vehicle image </h2>
            ...
            <div class="card card-shadow" style="align-items: center;display: flex;justify-content: center;">
                <div class="media-left pl-2 pt-2">
                        <a href="#" class="profile-image">
                            ...
                            <img src="{{ $user->vehicle_file }}" id="vehicle"  class="rounded-circle img-border height-100"  alt="Card image">
                            @else
                ...
                <div class="media-left" style="padding-top: 0.2rem !important;padding-left: 1.5rem !important;margin-bottom: 1.0rem !important;">
                    <label for="updatepic" class="btn btn-primary d-" style="background-color: #00c5dc !important;border-color: #00c5dc !important;padding: .75rem 2rem;border-radius:50px;">Upload Vehicle File</label>
                    <input type="file" class="image" id="updatepic" style="display: none" name="vehicle_file">
            ...
            <div class="card card-shadow" style="align-items: center;display: flex;justify-content: center;">
                <div class="media-left pl-2 pt-2">
                        <a href="#" class="profile-image">
                            ...
                            <img src="{{ $user->aadhar_image }}" id="aadhar"  class="rounded-circle img-border height-100"  alt="Card image">
                            @else
                ...
                <div class="media-left" style="padding-top: 0.2rem !important;padding-left: 1.5rem !important;margin-bottom: 1.0rem !important;">
                    ...
                    <a href="{{ url('/admin/employeekyc/aadhar').'/'.$user->id }}">Upload aadhar File</a>
                    </label>
                </div>
            </div>
        </div>
      ...
      <script>
        jQuery(function($) {
           ...
           $(".image").on("change", function(){
            ...
            $('.vehicle_screen').css('display','block');
