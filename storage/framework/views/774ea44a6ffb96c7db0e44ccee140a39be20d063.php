          ...
          <ul class="nav navbar-nav flex-row position-relative">
            ...
            <li class="nav-item mr-auto">
              <a class="navbar-brand" href="<?php echo e(route('admin.dashboard')); ?>">
                ...
                <img class="brand-logo" alt="modern admin logo" src="<?php echo e(url('/public/admin_logos/'.$general_setting->logo)); ?>">
                 <?php else: ?>
...
<?php /**PATH E:\xampp\htdocs\pneck_backend\resources\views/admin/includes/header.blade.php ENDPATH**/ ?>