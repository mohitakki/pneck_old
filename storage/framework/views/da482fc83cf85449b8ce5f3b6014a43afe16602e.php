                ...
                <div class="content">
                    ...
                    <div class="col-list-wrap left-list">
                        ...
                        <div class="list-main-wrap fl-wrap card-listing list-stf">
                            ...
                            <div class="p-0-20">
                                <!-- listing-item -->
                                <?php $__currentLoopData = $Vendor_skils; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="listing-item">
                                    <article class="geodir-category-listing fl-wrap">
                                        <div class="geodir-category-img">
                                            ...
                                            <img src="<?php echo e($vendor['profile_image']); ?>" alt="">
                                            <?php else: ?>
                                        ...
                                        <div class="geodir-category-content fl-wrap">
											...
											<h3><a href="<?php echo e(URL('/vendors_detail/'.$item->vendor_id )); ?>"><?php echo e($item->shop_title); ?></a></h3>
                                            ...
                                            <div class="sctr-str">
												<div class="loct-strs">
													...
													<?php echo e(Str::limit($item->address1, 18)); ?>

												</div>
												<ul class="right-sit">
													<li> <img src="<?php echo e(asset('public/asset/images/icon1.png')); ?>"> </li>
													<li> <img src="<?php echo e(asset('public/asset/images/icon2.png')); ?>"> </li>
												</ul>
											</div>
                                        </div>
                                    </article>
...
<?php /**PATH E:\xampp\htdocs\pneck_backend\resources\views/front/vendor_us.blade.php ENDPATH**/ ?>