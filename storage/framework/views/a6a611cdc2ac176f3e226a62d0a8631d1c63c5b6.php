                ...
                <div class="card-header">
                  ...
                  <div class="heading-elements">
                    <ul class="list-inline mb-0">
                      ...
                      <li><a href="<?php echo e(route('admin.banner-create')); ?>"><button type="button" class="btn btn-info mr-1 add-button">ADD</button></a></li>
                    </ul>
                  </div>
                </div>
                ...
                <div class="card-body card-dashboard">
                 ...
                 <table  class="table table-striped table-bordered zero-configuration">
                      ...
                      <tr style="text-align:center">
                        ...
                        <td><img src="<?php echo e(url($row->banner)); ?>" style="width: 80px;"></td>
                        <td>
                            <?php
                      ...
                      ?>
                        ...
                        <td><?php if($row->status == '0'): ?>
                          <a href="#" data-url="<?php echo e(route('admin.banner-check',$row->id)); ?>" class=" btn btn-danger check">Inactive </a>
                        ...
                        <td>
                          <a href="<?php echo e(route('admin.banner-edit',$row->id)); ?>">
                            <i class="la la-pencil"></i>
                          </a>
                          <?php if($row->status != '1'): ?>
                          <a href="#" data-url="<?php echo e(route('admin.banner-delete',$row->id)); ?>" class="delete"> 
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/mydata/pneck_backend-master/resources/views/admin/banner.blade.php ENDPATH**/ ?>