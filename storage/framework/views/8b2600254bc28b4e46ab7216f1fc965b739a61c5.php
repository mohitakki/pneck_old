<?php $__env->startSection('content'); ?>
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">Category Edit</h3>
                      ...
                      <div class="form-body">
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-md-6 mb-2">
                            <label for="projectinput3">Category Title</label>
                          ...
                          <div class="form-group col-md-6 mb-2">
                            <label for="projectinput2">Code</label>
                             ...
                             <input type="text" name="code" class="form-control" placeholder="Code"  required autocomplete="off" value="<?php echo e($data->code); ?>"/>
                          </div>

                          <div class="form-group col-md-6 mb-2">
                            <label for="projectinput2">Body</label>

                             <input type="text" name="body" class="form-control" placeholder="Body"  required autocomplete="off" value="<?php echo e($data->body); ?>"/>
                          </div>

                          <div class="form-group col-md-6 mb-2">
                            <label for="projectinput2">Category Images</label>

                             <input type="file" name="category_images" class="form-control"  required autocomplete="off" />
                             <img src="<?php echo e($data->category_images); ?>" alt="">
                          </div>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Volumes/mydata/pneck_backend-master/resources/views/admin/edit_category.blade.php ENDPATH**/ ?>